...
<title>Welcome to BugTrack/Administrator</title>
...
<table width="100%">
  <tr>
    ...
    <td><p>As an Administrator you can</p>
      <ul>
        <li>View all reported bugs, and assign bugs to different Technical Experts to fix it. </li>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td><div align="right"><img src="images/red-bug.png" alt="bug" width="200" height="113" /></div></td>
  </tr>
</table>
</td></tr>
