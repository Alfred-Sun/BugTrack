...
<title>Welcome to BugTrack/Adding Expert</title>
...
if("blank".equals((String)request.getParameter("msg")))
	...
	out.println("<div class=errortext>This LoginID Already Exists.</div>");
%>
    <form id="form" name="form" method="post" action="SignUp">
      <table width="300">
        <tr>
