...
<title>Welcome to BugTrack/Administrator/Configuring Experts.</title>
...
<table width="100%">
  <tr>
    ...
    <td valign="top">
	<p>&nbsp;</p>
	<form name="form" method="post" action="configexp1.jsp">
	<table width="400" >
	<%
	if("success".equals((String)request.getParameter("msg"))){
		out.print("<tr><td colspan=2 bgcolor=#FFD7AE class=smalltext align=center height=25><font color=blue>The Expert Configured Successfully!</font></td></tr>");
	}else if("error".equals((String)request.getParameter("msg"))){
		out.print("<tr><td colspan=2 bgcolor=#FFD7AE class=smalltext align=center height=25><font color=red>The Expert has already configured for this Product.</font></td></tr>");
	}
	%>
      <tr>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top"><div align="right"><img src="images/red-bug.png" width="200" height="113" /></div></td>
  </tr>
</table>
</td></tr>
